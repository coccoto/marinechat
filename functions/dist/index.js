...
/******/ 	return __webpack_require__(__webpack_require__.s = "./functions/src/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
const Delete = firebase_functions__WEBPACK_IMPORTED_MODULE_0___default.a.firestore.document('rooms/{roomId}/contents/{contentId}').onWrite((change, context) => {
  console.log('Aa');
});
/*
